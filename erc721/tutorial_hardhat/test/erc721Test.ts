...
describe('Start Example ERC721 test', async () => {
  ...
  describe('Test Transfer exampleERC721', () => {
    it('Should get correct MetaData for the Example ERC721 Contract', async () => {
      await expect(exampleERC721.mint(addr1.address))
  ...
  describe('Test Approval exampleERC721', () => {
    it('should get approved for the Example ERC721 Contract', async () => {
      await expect(exampleERC721.connect(addr1).approve(addr2.address, '1'))
  ...
  describe('Test TransferFrom ExampleERC721', async () => {
    it('Example ERC721 Contract should have erc721 token after TransferFrom', async () => {
      await expect(exampleERC721.connect(addr2).transferFrom(addr1.address, owner.address, '1'))
        .to.emit(exampleERC721, 'Transfer')
